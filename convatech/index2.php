	...
	<body>
        ...
        <script>
            ...
            if(voice) {
                ...
                lstnrr.src = "http://thimblr.com/semanticsai/engine_1.js?"+Math.random();
                document.getElementsByTagName('head')[0].appendChild(lstnrr);
            }
            
            var vr = 0;
            vr = getUrlParameter('vr');
        ...
        <div class="info-pane" id="details-panel" style="display:none">
            ...
            <h3 style="float:right">More Details >></h3>
