...
*/
				...
				loader.load( "/z3d/metro.ctm",   function( geometry ) {
					...
					callbackModel( geometry, 450, material1, 0.001, 300, -450, 0, 0 );
 ...
 */
                ...
                //loaderOBJ.load( '/z3d/metro_2.obj', function ( object ) {
                 loaderOBJMTL.load( '/z3d/metro_2.obj', '/z3d/metro_2.mtl', function ( object ) {
